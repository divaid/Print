package com.weixing.print.port;
...
public class Port {
	...
	public boolean open(String strBtAddr,int timeout)
	{
		...
		{
			TmpSock = null;
			//Log.e("ali", "createRfcommSocketToServiceRecord exception");
			isOpen = false;
			return false;
		}
		mmBtSocket = TmpSock;
